var createMyModule = (() => {
  ...
  return function (createMyModule) {
      ...
      process: function (queueBuffers) {
        ...
        for (var i = 0; i < RA.bufIndex; i++) {
          if (
            ...
            RA.buffers[i].endTime < currentTime
          ) {
            RA.buffers[i].endTime = 0
    ...
    function _RWebCamInit(caps1, caps2, width, height) {
      ...
      RWC.contexts[c].glTex =
        caps1 & (1 << RWC.RETRO_CAMERA_BUFFER_OPENGL_TEXTURE)
    ...
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["ff"]).apply(
        null,
        arguments,
      )
    })
...
else if (typeof exports === "object") exports["createMyModule"] = createMyModule
